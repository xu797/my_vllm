...
TEST(test_ir, pnnx_graph_ops) {
  ...
  std::string  param_path
      = "/home/xu/work/my_vllm/runtime/test/pnnx_test/demo_net.pnnx.param";
  std::string bin_path("/home/xu/work/my_vllm/runtime/test/pnnx_test/demo_net.pnnx.bin");
...
TEST(test_ir, pnnx_graph_operands) {
   ...
   */
  std::string bin_path("/home/xu/work/my_vllm/runtime/test/pnnx_test/demo_net.pnnx.bin");
  std::string param_path("/home/xu/work/my_vllm/runtime/test/pnnx_test/demo_net.pnnx.param");
