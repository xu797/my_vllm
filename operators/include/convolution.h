#ifndef MYVLLM_OPERATORS_CONVOLUTION_H_
#define MYVLLM_OPERATORS_CONVOLUTION_H_
...
private:
    void ConvGemmBias(
        const arma::fmat& input_matrix, sftensor output_tensor,
    ...
    arma::fmat Im2Col(
        sftensor input, uint32_t kernel_w, uint32_t kernel_h,
