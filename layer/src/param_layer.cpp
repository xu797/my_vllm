...
{
    // this->layer_name_ = std::move(layer_name);
}

void ParamLayer::InitWeightParam(
    const uint32_t param_count, const uint32_t param_channel,
